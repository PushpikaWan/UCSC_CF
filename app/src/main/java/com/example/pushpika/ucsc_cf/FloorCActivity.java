...
public class FloorCActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_floor_c);
        ...
        recyclerView.addItemDecoration(new FloorCActivity.GridSpacingItemDecoration(2, dpToPx(10), true));
    ...
    public void collectCompanyData(List<Object> stoles)  {
        ...
        for (Object entry : stoles){
            ...
            if ( singleUser.get("floor").toString().equals("C")){
    ...
    public void goFloors(View view){
        Intent intent = new Intent(FloorCActivity.this,FloorCMapActivity.class);

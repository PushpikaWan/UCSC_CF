...
public class FloorAActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView.addItemDecoration(new FloorAActivity.GridSpacingItemDecoration(2, dpToPx(10), true));
    ...
    public void collectCompanyData(List<Object> stoles)  {
        ...
        for (Object entry : stoles){
            ...
            if ( singleUser.get("floor").toString().equals("A")){
    ...
    public void goFloors(View view){
        Intent intent = new Intent(FloorAActivity.this,FloorAMapActivity.class);

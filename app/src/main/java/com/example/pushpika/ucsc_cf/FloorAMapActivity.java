...
public class FloorAMapActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        n1 = (TextView) findViewById(R.id.n_10);
        n2 = (TextView) findViewById(R.id.n_7);
        n3 = (TextView) findViewById(R.id.n_4);
        n4 = (TextView) findViewById(R.id.n_1);
        n5 = (TextView) findViewById(R.id.n_2);
        n6 = (TextView) findViewById(R.id.n_3);
        n7 = (TextView) findViewById(R.id.n_6);
        n8 = (TextView) findViewById(R.id.n_9);
        n9 = (TextView) findViewById(R.id.n_12);
        n10 = (TextView) findViewById(R.id.n_15);
    ...
    public void collectCompanyData(List<Object> stoles)  {
        ...
        for (Object entry : stoles){
           ...
           //singleUser.get("floor").toString().equals("W002"))
            ...
            if(singleUser.get("stoleID").equals("A1")){
            ...
            else if(singleUser.get("stoleID").equals("A2")){
            ...
            else if(singleUser.get("stoleID").equals("A3")){
            ...
            else if(singleUser.get("stoleID").equals("A4")){
            ...
            else if(singleUser.get("stoleID").equals("A5")){
            ...
            else if(singleUser.get("stoleID").equals("A6")){
            ...
            else if(singleUser.get("stoleID").equals("A7")){
            ...
            else if(singleUser.get("stoleID").equals("A8")){
            ...
            else if(singleUser.get("stoleID").equals("A9")){
            ...
            else if(singleUser.get("stoleID").equals("A10")){
